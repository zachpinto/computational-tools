...
- [Public APIs Lists](https://github.com/public-api-lists/public-api-lists)

#### Datasets
- [Public Datasets](https://github.com/awesomedata/awesome-public-datasets)
- Public Data Repositories [[1]](https://www.kdnuggets.com/2022/04/complete-collection-data-repositories-part-1.html) [[2]](https://www.kdnuggets.com/2022/04/complete-collection-data-repositories-part-2.html)
...
#### Data Science
- [Data Science Tools](https://github.com/pintoza/computational-econ#computational-economics-tools)
#### MLOps
##### End-to-End Machine Learning
- [AWS SageMaker](https://aws.amazon.com/sagemaker/)
- [Azure Machine Learning](https://azure.microsoft.com/en-us/products/machine-learning)
- [Google TFX](https://www.tensorflow.org/tfx)
- [IBM Watson](https://developer.ibm.com/tutorials/orchestrating-end-to-end-ml-workflows-with-watson-studio-pipelines/)
- [DataBricks](https://docs.databricks.com/en/mlflow/end-to-end-example.html)
- [DataRobot](https://www.datarobot.com/blog/what-a-machine-learning-pipeline-is-and-why-its-important/)
##### AutoML
...
- [Weights&Biases](https://docs.wandb.ai/?_gl=1*1mdeczd*_ga*MzE5NTA3NTc3LjE2OTE3MTUyMDc.*_ga_JH1SJHJQXJ*MTY5MTcxNTIwNi4xLjEuMTY5MTcxNTIwOS41Ny4wLjA.)
- [TensorBoard](https://www.tensorflow.org/tensorboard)
- [Neptune.ai](https://neptune.ai/)
##### Model Packaging
...
- [Streamlit](https://streamlit.io/)
- [Django](https://www.djangoproject.com/#:~:text=Django%20is%20a%20high%2Dlevel,needing%20to%20reinvent%20the%20wheel.)
- [Gradio](https://www.gradio.app/)
- [Docker](https://www.docker.com/)
##### Model Serving and Deployment
- [AWS Sagemaker](https://aws.amazon.com/sagemaker/)
- [Google AI Platform](https://cloud.google.com/ai-platform)
- [TensorBoard Serving](https://www.tensorflow.org/tfx/guide/serving)
...
- [EvidentlyAI](https://docs.evidentlyai.com/)
- [Prometheus](https://prometheus.io/)
- [Grafana](https://grafana.com/)
- [SageMAker Model Monitor](https://sagemaker.readthedocs.io/en/stable/amazon_sagemaker_model_monitoring.html)
