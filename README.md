...
4. [Google Collab](https://colab.google/resources/)
5. [Jupyter](https://github.com/Nyandwi/machine_learning_complete)
6. [iTerm2](https://iterm2.com/)
7. [Oh My Zsh](https://ohmyz.sh/)
8. [Powerlevel10k: A Zsh Theme](https://github.com/romkatv/powerlevel10k)
9. [Homebrew](https://brew.sh/)
10. [Git](https://git-scm.com/)
11. [GitHub](https://docs.github.com/get-started)
12. [Postman](https://www.postman.com/)
13. [1Password](https://1password.com/)
14. [Heroku](https://www.heroku.com/)
15. [Valentina](https://www.valentina-db.com/en/valentina-studio-overview)
16. [Docker](https://docs.docker.com/)
17. [Vagrant](https://developer.hashicorp.com/vagrant/docs)
...
5. [MS SQL Server](https://www.microsoft.com/en-us/sql-server/sql-server-downloads)
...
#### Event Streams
1. [Snowplow](https://snowplowanalytics.com/)
...
2. [Azure Data Lake](https://azure.microsoft.com/en-us/solutions/data-lake/)
...
2. [Amazon SageMaker Ground Truth](https://aws.amazon.com/sagemaker/groundtruth/)
...
1. [DVC](https://dvc.org/)
2. [Pachyderm](https://www.pachyderm.com/)
#### Feature Store
...
3. [Google TFX](https://www.tensorflow.org/tfx)
4. [IBM Watson](https://developer.ibm.com/tutorials/orchestrating-end-to-end-ml-workflows-with-watson-studio-pipelines/)
5. [DataBricks](https://docs.databricks.com/en/mlflow/end-to-end-example.html)
6. [DataRobot](https://www.datarobot.com/blog/what-a-machine-learning-pipeline-is-and-why-its-important/)
##### AutoML
1. [H20.ai](https://www.h2o.ai/)
2. [DataRobot](https://www.datarobot.com/)
3. [Google AutoML](https://cloud.google.com/automl)
##### ML Frameworks
...
3. [Talos](https://autonomio.github.io/talos/)
##### Experiment Tracking
1. [MLflow](https://mlflow.org/)
2. [Weights&Biases](https://docs.wandb.ai/?_gl=1*1mdeczd*_ga*MzE5NTA3NTc3LjE2OTE3MTUyMDc.*_ga_JH1SJHJQXJ*MTY5MTcxNTIwNi4xLjEuMTY5MTcxNTIwOS41Ny4wLjA.)
3. [TensorBoard](https://www.tensorflow.org/tensorboard)
4. [Neptune.ai](https://neptune.ai/)
##### Model Packaging
1. [Flask](https://flask.palletsprojects.com/en/2.3.x/)
2. [FastAPI](https://fastapi.tiangolo.com/)
3. [Streamlit](https://streamlit.io/)
4. [Django](https://www.djangoproject.com/#:~:text=Django%20is%20a%20high%2Dlevel,needing%20to%20reinvent%20the%20wheel.)
5. [Gradio](https://www.gradio.app/)
6. [Docker](https://www.docker.com/)
##### Model Serving and Deployment
1. [AWS Sagemaker](https://aws.amazon.com/sagemaker/)
2. [Google AI Platform](https://cloud.google.com/ai-platform)
3. [TensorBoard Serving](https://www.tensorflow.org/tfx/guide/serving)
4. [TorchServe](https://pytorch.org/serve/)
5. [Azure ML](https://azure.microsoft.com/en-us/services/machine-learning/)
6. [Kubeflow](https://www.kubeflow.org/)
7. [Seldon](https://www.seldon.io/)
...
1. [Arize](https://arize.com/docs/)
2. [EvidentlyAI](https://docs.evidentlyai.com/)
3. [Prometheus](https://prometheus.io/)
4. [Grafana](https://grafana.com/)
5. [SageMAker Model Monitor](https://sagemaker.readthedocs.io/en/stable/amazon_sagemaker_model_monitoring.html)
...
3. [GitLab CI/CD](https://about.gitlab.com/stages-devops-lifecycle/continuous-integration/)
##### Infrastructure Management
1. [Terraform](https://www.terraform.io/)
2. [Ansible](https://www.ansible.com/)
3. [Docker](https://www.docker.com/)
##### Specialized Hardware
1. [GPUs](https://www.nvidia.com/en-us/about-nvidia/ai-computing/)
2. [TPUs](https://cloud.google.com/tpu)

### Specialized Tools
#### NLP
1. [Langchain](https://langchain.ai/)
2. [Hugging Face](https://huggingface.co/)
3. [spaCy](https://spacy.io/)
#### Computer Vision
1. [OpenCV](https://opencv.org/)
2. [Dlib](http://dlib.net/)
3. [ImageAI](https://imageai.readthedocs.io/)
#### Reinforcement Learning Frameworks
1. [OpenAI Gym](https://gym.openai.com/)
2. [PySC2](https://github.com/deepmind/pysc2)
3. [Keras-RL](https://keras-rl.readthedocs.io/)
#### DevOps
...
3. [IBM Federated Learning](https://developer.ibm.com/technologies/artificial-intelligence/articles/federated-learning-for-ai-in-the-enterprise/)

#### Low-Code AI Platforms
1. [IBM Watson Studio](https://www.ibm.com/cloud/watson-studio)
2. [Microsoft Power Platform](https://powerplatform.microsoft.com/)
...
1. [AI Fairness 360](http://aif360.mybluemix.net/)
2. [IBM Watson OpenScale](https://www.ibm.com/cloud/watson-openscale)
3. [Microsoft Azure Responsible AI](https://www.microsoft.com/en-us/research/theme/responsible-ai/)
